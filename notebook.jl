...
# ╔═╡ 50d3cac6-1d07-40cf-8188-2631f26abf40
# ╠═╡ disabled = true
#=╠═╡
begin
	ps = GridVisualizer(; Plotter = PlutoVista, layout = (3, 1), legend=:lt)
	scalarplot!(ps[1,1], grid, ssol[idA, :]; limits=(0.0, 1.0), zoom = 4.5, markerevery=2, label="Distribution of species A")
	scalarplot!(ps[2,1], grid, ssol[idB, :]; limits=(0.0, 5.0), zoom = 4.5, title="Distribution of the species B")
	scalarplot!(ps[3, 1], bgrid, view(ssol[idC, :], bgrid); limits=(0.0, 1.0), title="Distribution of the surface species C", ylabel="u_C")
	reveal(ps);
end
  ╠═╡ =#
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "c082ea030c38002d555b8ec57ae4019114afb4d8"
